...
public class Dashboard_Slide extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dashboard__slide);
        ...
        View.OnClickListener bayar = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Dashboard_Slide.this, Bayar.class));
            }
        };
        ...
        View.OnClickListener transfer = new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Dashboard_Slide.this, Transfer.class));
            }
        };
        ...
        View.OnClickListener ewallet = new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Dashboard_Slide.this, Ewallet.class));
            }
        };
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.dashboard__slide, menu);
        return true;
    }
